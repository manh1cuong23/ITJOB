...
const DaskboardSearch: React.FC = () => {
  return (
    <div className="h-[480px] bg-cover bg-center bg-no-repeat bg-main-search py-[20px] relative">
      <h2 className="text-center font-bold text-[#1E1E1E]  text-[24px]">
        Tìm việc làm nhanh 24h, việc làm mới nhất trên toàn quốc.
      </h2>
      <p className="text-center text-s mb-[16px]">
        {' '}
