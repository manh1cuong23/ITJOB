...
export async function apiUserList(options?: RequestOptions) {
...
export async function getMe(options?: RequestOptions) {
  try {
    const response = await request(`/users/get-me`, {
      method: 'GET',
      ...(options || {}),
    });
    return response;
...
export async function updateMe(data: any, options?: RequestOptions) {
  try {
    const response = await request(`/users/update-me`, {
      method: 'PUT',
      data: data,
      ...(options || {}),
    });
