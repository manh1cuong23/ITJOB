...
const tagsViewSlice = createSlice({
  ...
  reducers: {
    ...
    removeLastName(state, action: PayloadAction<string>) {
      state.lastName = '';
    },
...
export const { setActiveTag, addTag, removeTag, removeAllTag, removeOtherTag , setLastName, removeLastName} = tagsViewSlice.actions;
